        ...
        if ( user ) {
            ...
            let info = await transporter.sendMail({
                ...
                html: "<p>Hello <b>"+ user.name + "</b>!</p>"
                    + "<p>If you want to reset your password click the link below or copy link to your browser, if not just ignore that message.</p>"
                    + "<a href='" + process.env.ROOTURL + "resetPassword/" + randomKey + "'>Click this link</a>"
                    + "<p>" + process.env.ROOTURL + "resetPassword/" + randomKey + "</p>"
                    + "<br><br>"
    ...
    try {
        ...
        let info = await transporter.sendMail({
            ...
            html: "<p>Hello <b>"+ userName + "</b>!</p>"
                + "<p>Click the link below or copy to your browser to activate your account:</p>"
                + "<a href='" + process.env.ROOTURL + "verify/" + randomKey + "'>Click this link</a>"
                + "<p>" + process.env.ROOTURL + "verify/" + randomKey + "</p>"
                + "<br><br>"
                + "Best Regards,<br>Tournament Service"
        });
